...
/*! @name PIO1_1 (number 59), LCD
  @{ */
#define LCD_SSEL1_PORT 1U                  /*!<@brief PORT peripheral base pointer */
#define LCD_SSEL1_PIN 1U                   /*!<@brief PORT pin number */
#define LCD_SSEL1_PIN_MASK (1U << 1U)      /*!<@brief PORT pin mask */
                                           /* @} */
